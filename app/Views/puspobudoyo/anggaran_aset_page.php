...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <h2>Halaman Pengajuan Anggaran Aset</h2>
            <br>
            ...
            <div class="btn-group">
                ...
                <a href="/puspobudoyo/anggaran_aset_page" class="btn btn-outline-primary active">Pengajuan Anggaran Aset</a>
            </div>
            <br><br>
                ...
                <tbody>
                    ...
                    foreach ($anggaran as $aset) : ?>
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="/puspobudoyo/detail_anggaran_page/<?= $div_id ?>/<?= $aset['id'] ?>" class="btn btn-outline-dark-inline btn-sm">
