...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <h2>Halaman Informasi Keuangan Pengeluaran Aset</h2>
            <br>

            <div class="btn-group">
                <a href="/puspobudoyo/pemasukan_aset_page" class="btn btn-outline-primary" aria-current="page">Pemasukan Aset</a>
                <a href="/puspobudoyo/pengeluaran_aset_page" class="btn btn-outline-primary active">Pengeluaran Aset</a>

                <form action="" method="post">
                    <div class="input-group">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Cari data pengeluaran ..." name="keyword" style="margin-left:18.95rem;">
                        </div>
                        <button class="btn btn-secondary" type="submit" name="submit" style="margin-left:13.18rem;"> <img src="/img/search.svg"></button>
                    </div>
                </form>
