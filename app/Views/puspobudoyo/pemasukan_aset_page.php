...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <h2>Halaman Informasi Keuangan Pemasukan Aset</h2>
            <br>

            <div class="btn-group">
                <a href="/puspobudoyo/pemasukan_aset_page" class="btn btn-outline-primary active" aria-current="page">Pemasukan Aset</a>
                <a href="/puspobudoyo/pengeluaran_aset_page" class="btn btn-outline-primary">Pengeluaran Aset</a>

                <form action="" method="post">
                    <div class="input-group">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Cari data pemasukan ..." name="keyword" style="margin-left:18.95rem;">
                        </div>
