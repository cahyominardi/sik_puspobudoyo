...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <h2>Halaman Informasi Keuangan Pemasukan Pagelaran</h2>
            <br>

            <div class="btn-group">
                <a href="/puspobudoyo/pemasukan_pagelaran_page" class="btn btn-outline-primary active" aria-current="page">Pemasukan Pagelaran</a>
                <a href="/puspobudoyo/pengeluaran_pagelaran_page" class="btn btn-outline-primary">Pengeluaran Pagelaran</a>

                <form action="" method="post">
                    <div class="input-group">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Cari data pemasukan ..." name="keyword" style="margin-left:16.62rem;">
                        </div>
