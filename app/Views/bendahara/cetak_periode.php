...
header("Content-Disposition: attachment; filename = Laporan Keuangan Periode $nama Tanggal $day2 $month2 $year2 s/d $day $month $year.xls");
?>

<html>

<body>
    <h2>Laporan Keuangan Periode <?= $nama ?> Per Tanggal <?= $day2 ?> <?= $month2 ?> <?= $year2 ?> s/d <?= $day ?> <?= $month ?> <?= $year ?></h2>
    <h3>Pemasukan Per Tanggal <?= $day2 ?> <?= $month2 ?> <?= $year2 ?> s/d <?= $day ?> <?= $month ?> <?= $year ?></h3>
    <table border="1">
        <thead>
            <tr>
                <th>No</th>
    ...
    <br><br>
    <h3>Pengeluaran Per Tanggal <?= $day2 ?> <?= $month2 ?> <?= $year2 ?> s/d <?= $day ?> <?= $month ?> <?= $year ?></h3>
    <table border="1">
        <thead>
            <tr>
                <th>No</th>
