...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <div class="btn-group">
                <a href="/bendahara/transaksi_masuk_page" class="btn btn-outline-primary active" aria-current="page">Transaksi Masuk</a>
                <a href="/bendahara/transaksi_keluar_page" class="btn btn-outline-primary">Transaksi Keluar</a>
